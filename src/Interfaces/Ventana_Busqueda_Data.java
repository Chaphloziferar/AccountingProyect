 ...
 * @author PC 2
 */
public class Ventana_Busqueda_Data extends javax.swing.JFrame {

    /**
     * Creates new form Ventana_Asiento_Data
     */
    public Ventana_Busqueda_Data() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Image6.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ventana_Busqueda_Data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ventana_Busqueda_Data().setVisible(true);
            }
        });
    }
